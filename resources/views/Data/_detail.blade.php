<div class="card card-custom p-4">
    ...
    <div>
        ...
        <div class="row">
            <div class="col-6">
                <p class="mb-1"><strong>Transport:</strong> <span class="float-end">Rp
                        {{ number_format($travel->transport_total, 0, ',', '.') }}</span></p>
                <p class="mb-1"><strong>Penginapan:</strong> <span class="float-end">Rp
                        {{ number_format($travel->accommodation_total, 0, ',', '.') }}</span></p>
                <p class="mb-3"><strong>Uang Harian:</strong> <span class="float-end">Rp
                        {{ number_format($travel->perdiem_total, 0, ',', '.') }}</span></p>
                <p class="border-top pt-2"><strong>Grand Total:</strong> <span class="float-end fw-bold text-success">Rp
                        {{ number_format($travel->grand_total, 0, ',', '.') }}</span></p>
            </div>
        </div>
    </div>
    ...
    <div class="mb-3 d-flex gap-2">
        ...
        <!-- langsung unduh PDF -->
        <a href="{{ route('data.spby.pdf', $travel) }}" target="_blank" rel="noopener" class="btn btn-primary">
            Unduh PDF
        </a>
    </div>
</div>